...
export const updateNote = async (req, res, next) => {
    try {
        ...
        const updatedNote = await Note.findByIdAndUpdate(req.params.id, { ...req.body, updatedAt: new Date() }, // Updating the note with the new content and setting updatedAt to now
